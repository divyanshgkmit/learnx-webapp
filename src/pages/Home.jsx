              ...
              <div className="text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                  ...
                  <Button
                    ...
                    variant="outline"
                    size="lg"
                    className="min-w-2xs border-gray-600 text-black hover:bg-gray-300 px-8 py-3 text-lg"
                  >
            ...
            <div className="container mx-auto max-w-4xl px-4">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                ...
                <div className="space-y-2">
                  ...
                  <div className="text-gray-400 font-medium">Courses</div>
                </div>
                <div className="space-y-2">
          ...
          <section className="py-15">
            <div className="container mx-auto max-w-6xl px-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <Card className="text-center border-gray-800 bg-slate-800/50 backdrop-blur-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="text-center">
                  ...
                  <p className="text-gray-400">
                    Create your free account as a student or instructor
                  </p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-gray-400">
                    Browse through hundreds of expert-led courses
                  </p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-gray-400">
                    Enroll in courses and begin your learning journey
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="py-15 text-white relative">
            ...
            <div className="container mx-auto max-w-4xl px-4 text-center relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                >
                  <Link to="/courses">View Course Catalog</Link>
                </Button>
              </div>
            </div>
          </section>
