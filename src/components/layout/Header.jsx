              ...
              {isAuthenticated ? (
                <div className="flex items-center space-x-4">
                  <div className="flex items-center space-x-2 bg-blue-500/10 px-3 py-2 rounded-lg border border-blue-500/20">
                    ...
                    <span className="text-blue-300 font-medium">{user?.fullName || "User"}</span>
                  </div>
                  <Button
        ...
        {isMenuOpen && (
          <div className="md:hidden mt-4 pt-4 border-t border-gray-800 bg-slate-900/95 backdrop-blur-lg rounded-lg shadow-xl">
            ...
            <div className="pt-4 border-t border-gray-700/50 space-y-3">
              {isAuthenticated ? (
                <>
                  <div className="flex items-center space-x-3 bg-blue-500/10 px-4 py-3 rounded-lg border border-blue-500/20 mb-3">
